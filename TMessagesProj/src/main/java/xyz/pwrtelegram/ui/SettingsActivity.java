...
import xyz.pwrtelegram.tgnet.SerializedData;
...
import xyz.pwrtelegram.ui.Adapters.BaseFragmentAdapter;
import xyz.pwrtelegram.ui.Cells.CheckBoxCell;
import xyz.pwrtelegram.ui.Cells.TextInfoCell;
import xyz.pwrtelegram.ui.Cells.EmptyCell;
import xyz.pwrtelegram.ui.Cells.HeaderCell;
import xyz.pwrtelegram.ui.Cells.ShadowSectionCell;
import xyz.pwrtelegram.ui.Cells.TextCheckCell;
import xyz.pwrtelegram.ui.Cells.TextDetailSettingsCell;
import xyz.pwrtelegram.ui.Cells.TextSettingsCell;
...
import xyz.pwrtelegram.ui.Components.NumberPicker;
            ...
            if (type == 0) {
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "PWRTelegram for Android v%s (%d) %s", pInfo.versionName, code, abi));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
