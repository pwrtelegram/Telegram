 ...
 */
package xyz.pwrtelegram.messenger.exoplayer.extractor;

import xyz.pwrtelegram.messenger.exoplayer.C;
import xyz.pwrtelegram.messenger.exoplayer.MediaFormat;
import xyz.pwrtelegram.messenger.exoplayer.MediaFormatHolder;
import xyz.pwrtelegram.messenger.exoplayer.ParserException;
import xyz.pwrtelegram.messenger.exoplayer.SampleHolder;
import xyz.pwrtelegram.messenger.exoplayer.SampleSource;
import xyz.pwrtelegram.messenger.exoplayer.SampleSource.SampleSourceReader;
import xyz.pwrtelegram.messenger.exoplayer.TrackRenderer;
import xyz.pwrtelegram.messenger.exoplayer.drm.DrmInitData;
import xyz.pwrtelegram.messenger.exoplayer.upstream.Allocator;
import xyz.pwrtelegram.messenger.exoplayer.upstream.DataSource;
import xyz.pwrtelegram.messenger.exoplayer.upstream.DataSpec;
import xyz.pwrtelegram.messenger.exoplayer.upstream.Loader;
import xyz.pwrtelegram.messenger.exoplayer.upstream.Loader.Loadable;
import xyz.pwrtelegram.messenger.exoplayer.util.Assertions;
import xyz.pwrtelegram.messenger.exoplayer.util.Util;
 ...
 *
 * <ul>
 * <li>MP4, including M4A ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.mp4.Mp4Extractor})</li>
 * <li>fMP4 ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor})</li>
 * <li>Matroska and WebM ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.webm.WebmExtractor})</li>
 * <li>Ogg Vorbis/FLAC ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.ogg.OggExtractor}</li>
 * <li>MP3 ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.mp3.Mp3Extractor})</li>
 * <li>AAC ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.ts.AdtsExtractor})</li>
 * <li>MPEG TS ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.ts.TsExtractor})</li>
 * <li>MPEG PS ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.ts.PsExtractor})</li>
 * <li>FLV ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.flv.FlvExtractor})</li>
 * <li>WAV ({@link xyz.pwrtelegram.messenger.exoplayer.extractor.wav.WavExtractor})</li>
  ...
  static {
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.webm.WebmExtractor")
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.mp4.Mp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.mp3.Mp3Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.ts.AdtsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.ts.TsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.flv.FlvExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.ogg.OggExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.ts.PsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.extractor.wav.WavExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.ext.flac.FlacExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
