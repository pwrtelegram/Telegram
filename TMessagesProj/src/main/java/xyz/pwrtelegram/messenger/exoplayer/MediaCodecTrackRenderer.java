...
import xyz.pwrtelegram.messenger.exoplayer.MediaCodecUtil.DecoderQueryException;
import xyz.pwrtelegram.messenger.exoplayer.drm.DrmInitData;
import xyz.pwrtelegram.messenger.exoplayer.drm.DrmSessionManager;
import xyz.pwrtelegram.messenger.exoplayer.util.Assertions;
import xyz.pwrtelegram.messenger.exoplayer.util.NalUnitUtil;
import xyz.pwrtelegram.messenger.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "xyz.pwrtelegram.messenger.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
