 ...
 */
package xyz.pwrtelegram.messenger.exoplayer.text;

import xyz.pwrtelegram.messenger.exoplayer.ExoPlaybackException;
...
import xyz.pwrtelegram.messenger.exoplayer.SampleSourceTrackRenderer;
 ...
 *
 * <ul>
 * <li>WebVTT ({@link xyz.pwrtelegram.messenger.exoplayer.text.webvtt.WebvttParser})</li>
 * <li>TTML
 * ({@link xyz.pwrtelegram.messenger.exoplayer.text.ttml.TtmlParser})</li>
 * <li>SubRip
 * ({@link xyz.pwrtelegram.messenger.exoplayer.text.subrip.SubripParser})</li>
 * <li>TX3G
 * ({@link xyz.pwrtelegram.messenger.exoplayer.text.tx3g.Tx3gParser})</li>
 * </ul>
 *
  ...
  static {
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.text.webvtt.WebvttParser")
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.text.ttml.TtmlParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.text.webvtt.Mp4WebvttParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.text.subrip.SubripParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("xyz.pwrtelegram.messenger.exoplayer.text.tx3g.Tx3gParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
