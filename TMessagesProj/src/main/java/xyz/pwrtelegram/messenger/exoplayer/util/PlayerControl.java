...
public class PlayerControl implements MediaPlayerControl {
   ...
   * {@link xyz.pwrtelegram.messenger.exoplayer.MediaCodecAudioTrackRenderer}, the recommended approach is
   * to extend the class and override
   * {@link xyz.pwrtelegram.messenger.exoplayer.MediaCodecAudioTrackRenderer#onAudioSessionId}.
   *
