...
public class MusicPlayerService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static final String NOTIFY_PREVIOUS = "xyz.pwrtelegram.android.musicplayer.previous";
    public static final String NOTIFY_CLOSE = "xyz.pwrtelegram.android.musicplayer.close";
    public static final String NOTIFY_PAUSE = "xyz.pwrtelegram.android.musicplayer.pause";
    public static final String NOTIFY_PLAY = "xyz.pwrtelegram.android.musicplayer.play";
    public static final String NOTIFY_NEXT = "xyz.pwrtelegram.android.musicplayer.next";
